...
2. `Add Addon` to the `Addon List` which you need in the order shown on the download website from top to bottom and enter the corresponding add-on data. Please refer to the related screenshots and don't forget to save.
