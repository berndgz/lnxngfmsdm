...
2. `Add Addon` to the `Addon List` in the order shown on the download website from top to bottom and enter the corresponding add-on data. Please refer to the accompanying screenshots and do not forget to save.
